    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="Request-APM.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Request</span></a></li>
         <li><a class="app-menu__item" href="Project-registration-APM.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Project Registration</span></a></li>
        <li><a class="app-menu__item active" href="Accepted-Request-APM.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Accepted Request</span></a></li>
      ...
      <div class="app-title">
        ...
        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
              <?php
$APMEmail=$_SESSION["email"];
include("connection.php");


//$sql="select e.Name,e.Email,p.Project_Name,p.Project_Location,o.Order_Description,o.Order_Amount from employee as e,orders as o,project as p where e.Email=o.Email and p.Project_ID=o.Project_ID and o.Order_Status='Checked' and o.Order_Review='accepted' and o.Order_Review2='accepted'and o.Payed='No'";
$sql="select e.Name,e.Email,p.Project_Name,p.Project_Location,o.Order_Description,o.Order_Amount,o.Payed from employee as e,orders as o,project as p where e.Email=o.Email and p.Project_ID=o.Project_ID and o.Order_Status='Checked' and ((o.Order_Review='acceptedPM' and o.Order_Review2='acceptedBDM') or (o.Order_Review='acceptedPM' and o.Order_Review2='acceptedMD') or (o.Order_Review='acceptedBDM' and o.Order_Review2='acceptedPM') or (o.Order_Review='acceptedBDM' and o.Order_Review2='acceptedMD') or (o.Order_Review='acceptedMD' and o.Order_Review2='acceptedPM') or (o.Order_Review='acceptedMD' and o.Order_Review2='acceptedBDM'))  and e.Email='$APMEmail'";
  ...
  echo "
    <tr>
      ...
      <td class='text-right'>
        ...
        <button class='btn btn-primary badge-pill' style='width: 80px' name='btnsendrequest'>SEND</button></br>
      </td>
      </form>
      <form action='' method='POST'>
        <td class='text-right'>
