    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="Request-BDM.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Request</span></a></li>
         <li><a class="app-menu__item active" href="Project-registration-BDM.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Project Registration</span></a></li>
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              <form method="POST" action="projectregister.php" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-block btn-primary btn-lg" name="btnSaveBDM">Save</button>
                </div>
              </form>
            </div>
