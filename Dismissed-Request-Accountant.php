    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="Project-registration-Accountant.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Project Registration</span></a></li>
         ...
         <li><a class="app-menu__item active" href="Dismissed-Request-Accountant.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Dismissed Request</span></a></li>
  ...
  echo "
    <tr>
      ...
      <form action='insertrequest.php' method='POST'>
        ...
        <button class='btn btn-primary badge-pill' style='width: 123px' name='btnupdaterequest'>Update Request</button></br>
      </td>
      </form>
      <!--td class='text-right'>
        <button class='btn btn-primary badge-pill' style='width: 80px' data-toggle='modal' data-target='#staticBackdrop'>SEND</button></br>
        <button class='btn btn-danger badge-pill' style='width: 80px' data-toggle='modal' data-target='#staticBackdrop'>DISMISS</button>
      </td-->
    </tr>";
