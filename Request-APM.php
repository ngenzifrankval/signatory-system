 ...
 <!--form class="user" action="insertuser.php" method="POST"-->
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="Request-APM.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Request</span></a></li>
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              <form method="POST" action="insertrequest.php" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-group">
                  <button class="btn btn-block btn-primary btn-lg" name="btnsubmitrequest" type="submit" name="btnsubmitAPM">Submit</button>
                </div>
