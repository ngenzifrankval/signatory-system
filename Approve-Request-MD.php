      ...
      <ul class="app-menu">
       <li><a class="app-menu__item" href="home-MD.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Home</span></a></li>
        ...
        <li><a class="app-menu__item" href="Project-registration-MD.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Project Registration</span></a></li>
         <li><a class="app-menu__item active" href="Approve-Request-MD.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Approve Request</span></a></li>
      ...
      <div class="container">
        ...
        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12col-md-12">
          <div class="tile">
            ...
            <?php
              if(isset($_SESSION['approveMD'])){
                if ($_SESSION['approveMD'] == 2){
      ...
      <div class=\"modal-body\">
          <form>
            ...
            <div class=\"form-group\">
                  ...
                  <textarea type=\"text\" class=\"form-control\" required=\"true\" placeholder=\"End date\" autocomplete=\"off\" name=\"txtArea\"
                   readonly>$row[11]</textarea>
            </div>  
            <div class=\"form-group\">
