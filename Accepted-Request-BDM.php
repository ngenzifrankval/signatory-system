    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
       <li><a class="app-menu__item" href="home-BDM.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Home</span></a></li>
        ...
        <li><a class="app-menu__item active" href="Accepted-Request-BDM.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Accepted Request</span></a></li>
         ...
         <li><a class="app-menu__item" href="Payed-Request-BDM.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Payed Request</span></a></li>
...
$sql="select e.Name,e.Email,p.Project_Name,p.Project_Location,o.Order_Description,o.Order_Amount from employee as e,orders as o,project as p where e.Email=o.Email and p.Project_ID=o.Project_ID and o.Order_Status='Checked' and ((o.Order_Review='acceptedPM' and o.Order_Review2='acceptedBDM') or (o.Order_Review='acceptedPM' and o.Order_Review2='acceptedMD') or (o.Order_Review='acceptedBDM' and o.Order_Review2='acceptedPM') or (o.Order_Review='acceptedBDM' and o.Order_Review2='acceptedMD') or (o.Order_Review='acceptedMD' and o.Order_Review2='acceptedPM') or (o.Order_Review='acceptedMD' and o.Order_Review2='acceptedBDM'))  and e.Email='$Email'";
