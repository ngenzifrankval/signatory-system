      ...
      <ul class="app-menu">
       <li><a class="app-menu__item" href="home-PM.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>
        ...
        <li><a class="app-menu__item" href="Accepted-Request-PM.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Accepted Request</span></a></li>
         ...
         <li><a class="app-menu__item active" href="report.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Print Report</span></a></li>
      </ul>
    </aside>
...
$sql="select e.Name,p.Project_Name,o.Order_Description,o.Date_After,o.Order_Amount,o.Order_Review,o.order_Review2 from employee as e,orders as o,project as p where e.Email=o.Email and p.Project_ID=o.Project_ID  and o.Payed='Yes' and p.Project_ID='$id'";
...
while($row=mysqli_fetch_array($query)){
  ...
  echo "
    <tr class='responsive'>
      ...
      <td>$row[1]</td>
      <td class='setColumnWidth contact'><div>$row[2]</div></td>
      <td>Project Manager and Business Develop manager</td>
      <td>$row[3]</td>
      <td>$row[4]</td>
