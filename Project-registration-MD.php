    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
       <li><a class="app-menu__item" href="home-MD.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Home</span></a></li>
        ...
        <li><a class="app-menu__item active" href="Project-registration-MD.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Project Registration</span></a></li>
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              <form method="POST" action="projectregister.php" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-block btn-primary btn-lg" name="btnSaveMD">Save</button>
                </div>
              </form>
            </div>
