...
<div class="modal fade" id="staticBackdrop" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
 ...
 <!--form class="user" action="insertuser.php" method="POST"-->
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="Accepted-Request-BDM.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Accepted Request</span></a></li>
         <li><a class="app-menu__item active" href="Dismissed-Request-BDM.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Dismissed Request</span></a></li>
        ...
        <!--li class="treeview is-expanded"><a class="app-menu__item" href="index.html" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Pages</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>DISMISSED REQUEST</h1>
          <p>Welcome</p>
        </div>
        ...
        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12col-md-12">
          <div class="tile">
            <h3 class="tile-title">Dismissed Request</h3>
            <div class="tile-body">
              <?php
...
//$sql="select e.Name,e.Email,p.Project_Name,p.Project_Location,o.Order_Description,o.Order_Amount,o.Order_Comment,o.Order_ID from employee as e,orders as o,project as p where e.Email=o.Email and p.Project_ID=o.Project_ID and o.Order_Comment<>'No comment' and o.Email='$email'";
$sql="select e.Name,e.Email,p.Project_Name,p.Project_Location,o.Order_Description,o.Order_Amount,o.Order_Comment,o.Order_ID from employee as e,orders as o,project as p where e.Email=o.Email and p.Project_ID=o.Project_ID and Order_Comment<>'No comment' and o.Email='$email'";
  ...
  echo "
    <tr>
      ...
      <form action='insertrequest.php' method='POST'>
          <td class='text-right'>
            <input type='hidden' name='idtake' value='$row[7]'/>
            <button class='btn btn-primary badge-pill' style='width: 122px' name='btnupdaterequest'>Update Request</button></br>
          </td>
      </form>
    </tr>";
