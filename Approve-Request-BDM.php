      ...
      <ul class="app-menu">
       <li><a class="app-menu__item" href="home-BDM.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Home</span></a></li>
        <li><a class="app-menu__item" href="Request-BDM.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Request</span></a></li>
         ...
         <li><a class="app-menu__item active" href="Approve-Request-BDM.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Approve Request</span></a></li>
      ...
      <div class="container">
        ...
        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12col-md-12">
          <div class="tile">
            ...
            <?php
              if(isset($_SESSION['approveBDM'])){
                if ($_SESSION['approveBDM'] == 2){
...
//$sql="select o.Order_ID,e.Name,e.Email,p.Project_Name,p.Project_Location,o.Order_Description,o.Order_Amount from employee as e,orders as o,project as p where e.Email=o.Email and p.Project_ID=o.Project_ID and o.Order_Status='Checked' and((o.Order_Review='Not accepted' and o.Order_Review2='Not accepted') or (o.Order_Review2='Not accepted' and o.Order_Review='acceptedPM') or (o.Order_Review2='Not accepted' and o.Order_Review='acceptedBDM') or (o.Order_Review2='Not accepted' and o.Order_Review='acceptedMD')) and o.Payed='No'";
//$sql="select o.Order_ID,e.Name,e.Email,p.Project_Name,p.Project_Location,o.Order_Description,o.Order_Amount from employee as e,orders as o,project as p where e.Email=o.Email and p.Project_ID=o.Project_ID and o.Order_Status='Checked' and((o.Order_Review='Not accepted' and o.Order_Review2='Not accepted') or (o.Order_Review2='Not accepted' and o.Order_Review='acceptedPM') or (o.Order_Review2='Not accepted' and o.Order_Review='acceptedBDM') or (o.Order_Review2='Not accepted' and o.Order_Review='acceptedMD')) and o.Payed='No'";
