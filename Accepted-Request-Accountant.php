...
<div class="modal fade" id="staticBackdrop" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
 ...
 <!--form class="user" action="insertuser.php" method="POST"-->
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="Project-registration-Accountant.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Project Registration</span></a></li>
         <li><a class="app-menu__item" href="Approve-Request-Accountant.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Validate Request</span></a></li>
          <li><a class="app-menu__item active" href="Accepted-Request-Accountant.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Accepted Request</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> ACCEPTED REQUEST</h1>
          <p>welcome</p>
        </div>
        ...
        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12col-md-12">
          <div class="tile">
            <h3 class="tile-title">Accepted Request</h3>
            <?php
              ...
              } else if ($_SESSION['pay'] == 3) {
                $_SESSION['pay']=1;
                 echo "<div class='alert1'>";
               echo "<span class=\"closebtn\" onclick=\"this.parentElement.style.display='none';\">&times;</span> ";   
               echo "<strong>Error!</strong> Payment not done!.";   
               echo "</div>";
              }
              }
            ?>
...
//$sql="select o.Order_ID,e.Name,e.Email,p.Project_Name,p.Project_Location,o.Order_Description,o.Order_Amount from employee as e,orders as o,project as p where e.Email=o.Email and p.Project_ID=o.Project_ID and o.Order_Status='Checked' and((o.Order_Review='acceptedPM' and o.Order_Review2='acceptedBDM') or (o.Order_Review2='acceptedPM' and o.Order_Review='acceptedMD') or (o.Order_Review='acceptedBDM' and o.Order_Review2='acceptedPM') or (o.Order_Review2='acceptedBDM' and o.Order_Review='acceptedMD') or (o.Order_Review='acceptedMD' and o.Order_Review2='acceptedPM') or (o.Order_Review2='acceptedMD' and o.Order_Review='acceptedBDM') or (o.Order_Review2='acceptedMD' and o.Order_Review='acceptedPM')) and o.Payed='No'";
$sql="select e.Name,e.Email,p.Project_Name,p.Project_Location,o.Order_Description,o.Order_Amount,e.Phone_No,o.Order_ID from employee as e,orders as o,project as p where e.Email=o.Email and p.Project_ID=o.Project_ID and o.Order_Status='Checked' and ((o.Order_Review='acceptedPM' and o.Order_Review2='acceptedBDM') or (o.Order_Review='acceptedPM' and o.Order_Review2='acceptedMD') or (o.Order_Review='acceptedBDM' and o.Order_Review2='acceptedPM') or (o.Order_Review='acceptedBDM' and o.Order_Review2='acceptedMD') or (o.Order_Review='acceptedMD' and o.Order_Review2='acceptedPM') or (o.Order_Review='acceptedMD' and o.Order_Review2='acceptedBDM')) and Payed='No' order by Date_Before";


$query = mysqli_query($con,$sql);
echo "<div class='container-fluid'>";
echo "<div class='col-xl-12 col-lg-12 col-sm-12 col-xs-12'>";
echo "<table class='table table-responsive table-striped '>
  <thead class='thead-dark'>
    <tr>
      ...
      <!--center><th scope='col'>SEND</th></center>
  ...
  echo "
    <tr>
      ...
      <td class='text-right'>
        ...
        <button type='submit' class='btn btn-primary badge-pill' style='width: 80px' name='btnpayrequest'>Pay</button></br>
      </td>
      </form>
    </tr>";
